...
@SpellHandler(name = "Enchant Sharpness",
    description = "Enchants a weapon with Sharpness",
    permission = "merlin.cast.enchantment.sharpness")
public class EnchantSharpness implements MagicSpell
  {
