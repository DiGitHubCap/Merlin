...
@SpellHandler(name = "Enchant Punch",
    description = "Enchants a bow with Punch",
    permission = "merlin.cast.enchantment.punch")
public class EnchantPunch implements MagicSpell
  {
        ...
        if (isTool(hand))
          {
            ...
            hand.addEnchantment(Enchantment.ARROW_KNOCKBACK, level);
            return true;
          }
        else
          {
