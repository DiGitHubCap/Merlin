...
@SpellHandler(name = "Enchant Efficiency",
    description = "Enchants a tool with Efficiency",
    permission = "merlin.cast.enchantment.efficiency")
public class EnchantEfficiency implements MagicSpell
  {
    private final Set<Material> tools = new HashSet<Material>();
      
      {
        Collections.addAll(tools, new Material[] {Material.SHEARS,
            Material.WOOD_AXE, Material.WOOD_PICKAXE, Material.WOOD_SPADE,
            Material.STONE_AXE, Material.STONE_PICKAXE, Material.STONE_SPADE,
            Material.IRON_AXE, Material.IRON_PICKAXE, Material.IRON_SPADE,
            Material.GOLD_AXE, Material.GOLD_PICKAXE, Material.GOLD_SPADE,
        ...
        if (isTool(hand))
          {
            ...
            hand.addEnchantment(Enchantment.DIG_SPEED, level);
            return true;
          }
        else
          {
