...
@SpellHandler(name = "Enchant Bane of Arthropods",
    description = "Enchants a weapon with Bane of Arthropods",
    permission = "merlin.cast.enchantment.baneofarthropods")
public class EnchantBaneOfArthropods implements MagicSpell
  {
        ...
        if (isWeapon(hand))
          {
            ...
            hand.addEnchantment(Enchantment.DAMAGE_ARTHROPODS, level);
            return true;
          }
        else
          {
