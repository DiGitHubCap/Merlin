...
@SpellHandler(name = "Enchant Knockback",
    description = "Enchants a weapon with Knockback",
    permission = "merlin.cast.enchantment.knockback")
public class EnchantKnockback implements MagicSpell
  {
        ...
        if (isSword(hand))
          {
            ...
            hand.addEnchantment(Enchantment.KNOCKBACK, level);
            return true;
          }
        else
          {
