...
@SpellHandler(name = "Enchant Looting",
    description = "Enchants a weapon with Looting",
    permission = "merlin.cast.enchantment.looting")
public class EnchantLooting implements MagicSpell
  {
        ...
        if (isSword(hand))
          {
            ...
            hand.addEnchantment(Enchantment.LOOT_BONUS_MOBS, level);
            return true;
          }
        else
          {
